...
$(document).ready(function(){
		...
		var wipeAnimation = new TimelineMax()
		 	...
		 	.to("#start", 5, {y: '-200%', ease: Circ.easeOut}, "-=1.5")
			

			.fromTo("#panel--one", 10, {x: 3000}, {x: -3000, ease: Power0.easeNone}, "frame1")
			...
			.fromTo("#panel--one-third", 10, {x: 3000}, {x: -3000, ease: Power0.easeNone}, "frame1")
			...
			.fromTo("#panel--two", 10, {x: 3000}, {x: -3000, ease: Power0.easeNone})
			.to("#start1", 8, {morphSVG:{shape:"#end1", shapeIndex:16}, ease: Circ.easeOut}, "-=5.5")
			
			// animate to third panel
			// .to("#slide-wrap", .25, {z: -150, ease: Power0.easeNone})
			// .to("#slide-wrap", .25, {z: 0, ease: Power0.easeNone})
			
			.fromTo("#panel--three", 10, {x:  3000}, {x: -3000, ease: Power0.easeNone})
			
			// animate to fourth panel
			// .to("#slide-wrap", .25, {z: -150, ease: Power0.easeNone})
			// .to("#slide-wrap", .25, {z: 0, ease: Power0.easeNone})
			
			.fromTo("#panel--four", 10, {x: 3000}, {x: -3000, ease: Power0.easeNone});
