...
$(document).ready(function(){
		...
		var panel1Timeline = new TimelineMax()
			...
			.from(".panel-content-one h6", 1, {y: '-100%', ease: Power0.easeNone}, "-=.25")
			.from(".panel-content-one h1", 1, {y: '-100%', ease: Power0.easeNone}, "-=.25")
			.from(".panel-content-one p.right", 1, {y: '-100%', ease: Power0.easeNone}, "-=.25");
